...
public class Wrapper {
	...
	public static void main(String[] args) {
		...
		//기본형을 참조형으로 표혀날 수 있기 떄문에 Object 클래스의 변수에는 모든 데이터 대입가능
		Object obj = 300;
		...
		//실수 연산에 문제점 발생
		double d1 = 1.6000000000000000000000000000000;
		double d2 = 0.1000000000000000000000000000000;
		...
		//프로그램 언어와 데이터베이스를 연동하는 경우
		//대부분의 경우 데이터베이스가 더 정밀한 숫자를 저장하는 경우가 많습니다.
		//데이터베이스에 실수를 저장했을 때는 float이나 double로 받는 것 보다는 BigDecimal
		//같은 클래스를 이용해서 저장하고 연산한 후 결과를 float이나 double로 표현하는 것이 좋습니다.
